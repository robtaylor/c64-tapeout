...
**Status:** Superseded (2026-06-30) by [ADR 0004](0004-external-qspi-psram.md) for the main-RAM decision, and (2026-07-06) by [ADR 0005](0005-external-flash-roms.md) for the **ROM decision** — KERNAL/BASIC/CHARGEN move to external QSPI flash because the synthesized LUT ROMs made the core unroutable. Only the **color-RAM** strategy below (1024×4 synthesized flip-flops) still applies.
