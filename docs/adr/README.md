...
| [0005](0005-external-flash-roms.md) | External QSPI flash for ROMs (shared bus, 2nd CS) | Accepted (2026-07-06, amended 2026-07-09: source-sync QSPI timing) |
| [0006](0006-qspi-io-voltage-domain.md) | QSPI IO voltage domain (3.3 V memories vs 5 V GF180 IO) | Proposed (pending spike) |
